...
export default function TableOrderingPage() {
  ...
  const t = {
    ar: {
      ...
      applePay: "Apple Pay / Google Pay (دفع سريع)",
      cardPay: isQatarLocation ? "نابس (NAPS) / بطاقة بنكية" : "مدى (Mada) / بطاقة بنكية",
      counterPay: "الدفع عند الكاشير",
      phone: "رقم الجوال (اختياري - للواتساب ونقاط الولاء)",
      email: "البريد الإلكتروني (اختياري - للفاتورة والرصيد)",
    ...
    fr: {
      ...
      phone: "N° de téléphone (optionnel - WhatsApp & fidélité)",
      email: "Email (optionnel - pour facture & reçu digital)",
    ...
    en: {
      ...
      phone: "Phone Number (optional - for WhatsApp & loyalty)",
      email: "Email (optional - for e-invoice & receipt)",
      emailPlaceholder: "name@example.com",
